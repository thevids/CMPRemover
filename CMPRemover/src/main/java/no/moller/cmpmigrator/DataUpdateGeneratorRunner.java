...
public final class DataUpdateGeneratorRunner {
    ...
    public static void main(final String[] args) throws SAXException, IOException {
        ...
        for (File file : listFiles) {
            ...
            String classToGenerateFor = file.getName().substring(0, file.getName().indexOf(".java"));
...
//      generate(classToGenerateFor);
    ...
    private static void generate(String classToGenerateFor)
        ...
        DataGenerator generator = new DataGenerator(FILE_PATH_TO_OLD_CODE,
                FILE_PATH_TO_OLD_DATA_CODE,
                NEW_PACKAGE,
